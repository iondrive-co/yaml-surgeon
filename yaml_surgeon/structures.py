...
class SyntaxNode:
    def __init__(self, name, line_number, flow_style="", is_sequence=False):
        self.name = name
    ...
    def deep_copy(self, insert_at_line):
        ...
        copied_node = SyntaxNode(self.name, insert_at_line, self.flow_style, self.is_sequence)
    ...
    def __repr__(self):
        return f"SyntaxNode(name='{self.name}', " \
               ...
               f"is_sequence='{self.is_sequence}', " \
